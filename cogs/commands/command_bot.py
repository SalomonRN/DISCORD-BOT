...
class CommandsBot(discord.ext.commands.Cog):
    ...
    @app_commands.command(name="idea", description="Quieres hacer una sugerencia? Aquí puedes hacerlo 😊")
    @app_commands.describe(idea="Escribe tu idea o sugerencia aquí")
